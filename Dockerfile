...
COPY *.sln .
COPY KeyGenerator2/*.csproj KeyGenerator2/
RUN dotnet restore KeyGenerator2/KeyGenerator2.csproj

# Copy the rest of the source code
COPY KeyGenerator2/ KeyGenerator2/
WORKDIR /src/KeyGenerator2
...
ENTRYPOINT ["dotnet", "KeyGenerator2.dll"]
